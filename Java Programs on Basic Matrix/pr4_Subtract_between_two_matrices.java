...
public class pr4_Subtract_between_two_matrices 
{
	...
	private static void substraction_of_matrix(int[][] first, int[][] second, int row, int column)
	{
		int r, c;
	...
	public static void main(String[] args) 
	{
		...
		substraction_of_matrix(firstMatrix, secondMatrix,row, column);
	}
}