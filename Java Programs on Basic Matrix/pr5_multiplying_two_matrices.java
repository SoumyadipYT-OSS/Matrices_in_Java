...
public class pr5_multiplying_two_matrices 
{
	...
	private static void multiplying_of_matrix(int[][] first, int[][] second, int row, int column)
	{
		int r, c;
	...
	public static void main(String[] args) 
	{
		...
		System.out.println("• The multiplication of these two matrices →");
		multiplying_of_matrix(firstMatrix, secondMatrix,row, column);
	}
}
